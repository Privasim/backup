      ...
      <div className="flex items-center justify-center px-6 py-20">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
            <Link href="/businessidea/profile-settings?step=1" className="btn-primary btn-lg min-w-[160px] focus-ring">
              Start Assessment
            </Link>
            <Link href="/research" className="btn-secondary btn-lg min-w-[160px] focus-ring">
              Explore Research
            </Link>
          </div>
        </div>
