    ...
    <div className="rounded-xl border border-gray-200 bg-white shadow-sm p-3 sm:p-4">
      ...
      {(summary || narratives?.riskNarrative) && (
        <div>
          ...
          <p className="text-sm text-gray-700">{summary || narratives?.riskNarrative}</p>
          {riskScore !== undefined && (
      ...
      {(threatDrivers && threatDrivers.length > 0) || narratives?.threatNarrative ? (
        <div>
          ...
          {narratives?.threatNarrative ? (
            <p className="text-sm text-gray-700 mb-2">{narratives.threatNarrative}</p>
      ...
      {(automationExposure && automationExposure.length > 0) || narratives?.automationNarrative ? (
        <div>
          ...
          {narratives?.automationNarrative ? (
            <p className="text-sm text-gray-700 mb-2">{narratives.automationNarrative}</p>
      ...
      {(skillImpacts && skillImpacts.length > 0) || narratives?.skillsNarrative ? (
        <div>
          ...
          {narratives?.skillsNarrative ? (
            <p className="text-sm text-gray-700 mb-2">{narratives.skillsNarrative}</p>
      ...
      {(mitigation && mitigation.length > 0) || narratives?.mitigationNarrative ? (
        <div>
          ...
          {narratives?.mitigationNarrative ? (
            <p className="text-sm text-gray-700 mb-2">{narratives.mitigationNarrative}</p>
