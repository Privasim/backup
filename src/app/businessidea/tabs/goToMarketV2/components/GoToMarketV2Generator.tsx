  ...
  return (
    <div className="p-4 max-w-6xl mx-auto">
      <div className="mb-4 flex justify-between items-start">
        <div>
          <h1 className="text-xl font-bold text-gray-900 mb-1">Go-to-Market Strategy Generator</h1>
          <p className="text-xs text-gray-600">Generate a comprehensive go-to-market strategy based on your implementation plan</p>
        </div>
        <div className="flex items-center gap-2">
          <button
            onClick={handleGenerate}
            disabled={isLoading || !isContextValid || !isConfigValid}
            className={`px-4 py-2 text-sm rounded-lg font-medium flex items-center ${
      ...
      <div className="mb-4 flex flex-wrap gap-3">
        ...
        {isLoading && (
          <button
            ...
            className="px-4 py-2 text-sm rounded-lg font-medium bg-red-100 text-red-700 hover:bg-red-200"
          >
            Cancel
          </button>
        )}
      ...
      {isError && error && (
        <div className="mb-4 p-3 rounded-lg bg-red-50 border border-red-200">
          <div className="flex items-center">
            ...
            <div className="ml-2">
              <h3 className="text-xs font-medium text-red-800">Generation Error</h3>
