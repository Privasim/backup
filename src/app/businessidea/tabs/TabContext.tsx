...
export const validTabs = ['businessplan', 'userprofile', 'financials', 'tools', 'visualization', 'jobrisk', 'list', 'mobile', 'gotomarket-v2', 'artifact-studio', 'specs', 'implementation-plan', 'image-editor'] as const;
